...
public class FirstController {
    ...
    public String registMenu(Model model, WebRequest request) {
        ...
        String message = menuName + "을(를) 신규 메뉴 목록의 " + categoryCode + "빈 카테고리에 " + menuPrice + "원으로 등록하셨습니다!";
    ...
    @PostMapping("modify")
    public String modifyenuPrice(Model model,
