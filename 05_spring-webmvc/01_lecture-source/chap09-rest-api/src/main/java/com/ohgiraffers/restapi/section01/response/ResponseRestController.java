...
public class ResponseRestController {
    ...
    public byte[] getImage() throws IOException {
        ...
        return new FileInputStream("C:\\lecture\\05_spring-webmvc\\01_lecture-source\\chap09-rest-api\\src\\main\\java\\com\\ohgiraffers\\restapi\\section01\\response\\sample.png").readAllBytes();
    }

    @GetMapping("/entity")
    public ResponseEntity<Message> getEntity() {

        return ResponseEntity.ok(new Message(123, "helloword!"));
    }
}
