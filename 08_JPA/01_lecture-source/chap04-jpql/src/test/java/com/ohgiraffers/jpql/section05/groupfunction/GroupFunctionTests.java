...
public class GroupFunctionTests {
     ...
     * 3. 그룹함수의 반환 자료형은 Long of Double이기 때문에
    ...
    @DisplayName("GROUP BY절과 HABING절을 사용한 조회 테스트")
    @ParameterizedTest
    ...
    void testSumMenuPriceGroupByCategoryCode(long minPrice){
        ...
        Assertions.assertDoesNotThrow(
                () -> {
                    List<Object[]> sumPriceOfCategories = groupFunctionService.sumMenuPriceGroupByCategory(minPrice);
